...
//                string word = TrimWord(raw, separators);
...
//            _output = letters.ToArray();
//        }

//        private string TrimWord(string word, char[] separators)
//        {
//            int start = 0;
//            int end = word.Length - 1;

//            while (start <= end && IsSeparator(word[start], separators))
//                start++;

//            while (end >= start && IsSeparator(word[end], separators))
//                end--;
